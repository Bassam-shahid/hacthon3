...
// فرض کریں کہ cartData اور totalPrice کہیں سے آ رہے ہیں
// آپ اسے اپنی Cart یا Context سے لے سکتے ہیں۔

export default function CheckOut() {
  // فرضی طور پر cartData اور totalPrice کا ڈیٹا
          ...
          <div className="bg-white shadow-md rounded-lg p-6">
            ...
            <div className="border-b pb-4 mb-4">
              ...
              <div className="flex justify-between text-gray-700 font-bold text-lg mt-2">
                <span>Total</span>
                <span className="text-darkyellow">Rs. {totalPrice}.00</span>
              </div>
            </div>
